...
//        FileHandler.copy(screenshot, destination);
	   ...
	   launchBrowser(prop.getProperty("admin_url"));
		...
		accpatient.Submit();
		WebDriverWait waitAdmin = new WebDriverWait(driver, Duration.ofSeconds(10));  // Wait for up to 10 seconds
		Alert alertAdmin = waitAdmin.until(ExpectedConditions.alertIsPresent());
		extentTest.info("Switching to Alert");
