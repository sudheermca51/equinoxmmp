...
public class InformationPage {
	...
	public InformationPage(WebDriver driver)
	{
		...
		if (!driver.getTitle().equals("information")) {
			throw new IllegalStateException("This is not Information Page," +
				" current page is: " + driver.getCurrentUrl());
			
	}
	
		setScreenshotUtil(new ScreenshotUtil(driver));	
	}
	...
	public static void setScreenshotUtil(ScreenshotUtil screenshotUtil) {
		InformationPage.screenshotUtil = screenshotUtil;
	}
